...
//     L2(Degrees.of(90), Constants.CoralManipulator.SCORE_SPEED),
...
//     }
    ...
    public enum ManipulatorState {
        IDLE(0),
        L1(Constants.CoralManipulator.SCORE_SPEED),
        L2(Constants.CoralManipulator.SCORE_SPEED),
        L3(Constants.CoralManipulator.SCORE_SPEED),
        L4(Constants.CoralManipulator.SCORE_SPEED),
